...
static void usage()
{
	fprintf(stderr, "Usage: pcm_parse -i filename\n");
}
...
int main(int argc, char *argv[])
{
	...
	fprintf(stderr, "The decoded tiff name is pcm_parse.tif\n");
    ...
    if (t4_rx_init(&t4_rx_state, "pcm_parse.tif", T4_COMPRESSION_ITU_T4_2D) == NULL)
    {
