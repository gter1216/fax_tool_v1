...
//static void usage()
//{
//	fprintf(stderr, "Usage: modem connect tones_gen \n"
//		"                   1a: CNG generation to a file\n"
//		"                   1b: CED/ANS generation to a file\n"
//		"                   1c: ANSam(Modulated ANS) generation to a file\n"
//		"                   1d: ANS/ (EC-disable) generation to a file\n"
//		"                   1d: ANSam/ (Modulated EC-disable) generation to a file\n"
//		"                   2a: CNG detection with frequency\n"
//		"                   2b: CED/ANS detection with frequency\n"
//	    "                   2c: ANSam detection with frequency\n"
//	    "                   2d: ANS/ (EC-disable) detection with frequency\n"
//		"                   2e: ANSam/ (Modulated EC-disable) detection with frequency\n"
//		"                   3a: CNG detection with level\n"
//		"                   3b: CED/ANS detection with level\n"
//		"                   3c: ANSam detection with level\n"
//		"                   3d: ANS/ (EC-disable) detection with level\n"
//		"                   3e: ANSam/ (Modulated EC-disable) detection with level\n"
//		"                   4: CED detection, when stimulated with V.21 pr\n"
//	);
//}
static void usage()
{
	fprintf(stderr, "Usage: modem connect tones_detect -d tone_file\n"
	);
}
/*- End of function --------------------------------------------------------*/
